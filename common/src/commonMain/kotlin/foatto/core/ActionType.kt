...
object ActionType {
    ...
    const val MODULE_CHART: String = "MODULE_CHART"
    const val MODULE_MAP: String = "MODULE_MAP"
    const val MODULE_SCHEME: String = "MODULE_SCHEME"
    const val MODULE_COMPOSITE: String = "MODULE_COMPOSITE"

    const val FORM_ADD: String = "FORM_ADD"
    const val FORM_EDIT: String = "FORM_EDIT"
    const val FORM_DELETE: String = "FORM_DELETE"
    const val FORM_EXIT: String = "FORM_EXIT"
    const val FORM_SELECTOR: String = "FORM_SELECTOR"

    const val GET_COORDS: String = "GET_COORDS"
    const val GET_ELEMENTS: String = "GET_ELEMENTS"
}
//    GET_ONE_ELEMENT,
//    CLICK_ELEMENT,
//    ADD_ELEMENT,
