...
import foatto.compose.getStyleTableRowIconNameSuffix
...
//    IconName.PRINT_TABLE to "/images/ic_print_${getStyleToolbarIconNameSuffix()}.png",
    IconName.SELECT to "/images/ic_reply_${getStyleTableRowIconNameSuffix()}.png",

    //--- Table Row Icons ---

    //--- подраздел
//    IconName.FOLDER to "/images/ic_folder_open_${getStyleTableRowIconNameSuffix()}.png",

    //--- подразделение
    IconName.DIVISION to "/images/ic_folder_shared_${getStyleTableRowIconNameSuffix()}.png",
    //--- руководитель
    IconName.BOSS to "/images/ic_account_box_${getStyleTableRowIconNameSuffix()}.png",
    //--- работник
    IconName.WORKER to "/images/ic_account_circle_${getStyleTableRowIconNameSuffix()}.png",
