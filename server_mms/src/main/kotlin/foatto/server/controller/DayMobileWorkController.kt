...
import foatto.server.service.DayMobileWorkService
...
@RestController
class DayMobileWorkController(
    private val dayWorkService: DayMobileWorkService,
) {

    @PostMapping(ApiUrlMMS.DAY_MOBILE_WORK)
    @Transactional
    fun app(
        @RequestBody
    ...
    @PostMapping(ApiUrlMMS.DAY_MOBILE_WORK_FORM_ACTION)
    @Transactional
    fun formAction(
        @RequestBody
